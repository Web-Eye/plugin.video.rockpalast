...
class DBAPI:
    ...
    def __init__(self, db_config, tag):
        ...
        if tag is not None:
            ...
            if 'suppress_Interview' in tag:
                self._suppress_Interview = tag.get('suppress_Interview')
            if 'suppress_Unplugged' in tag:
    ...
    def getTeaser(self):
        ...
        if self._suppress_Interview and self._suppress_Unplugged:
            query['tag'] = 'None'
        elif self._suppress_Interview:
            query['nTag'] = 'INTERVIEW'
        elif self._suppress_Unplugged:
            query['ntag'] = 'UNPLUGGED'
